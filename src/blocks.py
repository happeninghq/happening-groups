...
def staff_event_tickets_headers(request, event, ticket):
    ...
    return render_to_string("groups/blocks/admin/event/tickets/headers.html",
...
def staff_event_tickets_info(request, event, ticket):
    ...
    return render_to_string("groups/blocks/admin/event/tickets/info.html",
                            {"event": event, "ticket": ticket})
...
def staff_event_buttons(request, event):
    ...
    return render_to_string("groups/blocks/admin/event/buttons.html",
                            {"event": event})
